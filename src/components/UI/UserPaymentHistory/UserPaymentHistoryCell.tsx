...
interface IMangeUserCellProps {
  columnKey: string;
  payment: any; // Assuming payment object structure is defined elsewhere
}

const UserPaymentHistoryCell: React.FC<IMangeUserCellProps> = ({
  columnKey,
  payment,
}) => {
...
export default UserPaymentHistoryCell;
